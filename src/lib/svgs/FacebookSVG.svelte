<a
	href="https://www.facebook.com/GolfAlpineMeadows/"
	target="_blank"
	class="p-4 opacity-85 hover:opacity-65 md:p-1"
>
	<svg
		aria-label="Alpine Meadows Golf Course on Facebook"
		fill="currentColor"
		height="24"
		role="img"
		viewBox="0 0 24 24"
		width="24"
		><title>Alpine Meadows Golf Course on Facebook</title><circle
			cx="12"
			cy="12"
			fill="none"
			r="11.25"
